...
export const MapIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      height={size}
      strokeLinejoin="round"
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M5.5 1.14648L1.5 3.01314V13.4536L5 11.8536L5.5 11.6203V11.0869V1.14648ZM10.5 4.91309V14.8535L6.99999 13.1869V3.14648L10.5 4.91309ZM14.5 2.54638L11.5607 3.98571L11 4.27856V4.91309V14.9131V15.4464L11.5 15.6798L14.5 16.9298V2.54638ZM5.49999 0L5.99999 0.233349L10.5 2.56668L15 0.400017L16 -0.0666504V1V15.3333V16.4L15 15.9333L10.5 13.6L5.99999 15.7667L5.49999 16L4.99999 15.7667L0.499993 13.4333L-0.500007 12.9667V11.9V1.56668V0.500017L0.499993 0.966683L5.49999 0Z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M2.5 1.5V14.5H13.5V5.91421L9.08579 1.5H2.5ZM1 1C1 0.447715 1.44772 0 2 0H9.5L15 5.5V15C15 15.5523 14.5523 16 14 16H2C1.44772 16 1 15.5523 1 15V1ZM10.75 9.5H5.25H4.5V8H5.25H10.75H11.5V9.5H10.75ZM5.25 12H4.5V13.5H5.25H10.75H11.5V12H10.75H5.25Z"
        fill="currentColor"
      />
    </svg>
  );
...
export const LayoutSplitIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      height={size}
      strokeLinejoin="round"
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M1.5 2.5H14.5V7.25H1.5V2.5ZM1.5 8.75H14.5V13.5H1.5V8.75ZM0 2C0 1.44772 0.447715 1 1 1H15C15.5523 1 16 1.44772 16 2V14C16 14.5523 15.5523 15 15 15H1C0.447715 15 0 14.5523 0 14V2Z"
        fill="currentColor"
      />
    </svg>
  );
