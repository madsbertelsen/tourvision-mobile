...
export default function EditLocationRoute() {
  ...
  const { setGeoMarkUpdate, locations, bottomSheetRef } = useDocumentNextWebRTCContext();
  ...
  useEffect(() => {
    // Make sure bottom sheet is expanded to 90% for editing
  ...
  const handleSave = () => {
    ...
    console.log('[EditLocation] Saving location:', {
