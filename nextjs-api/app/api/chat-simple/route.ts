...
<span class="geo-mark" data-geo-id="loc-1" data-color-index="0" data-lat="APPROXIMATE_LAT" data-lng="APPROXIMATE_LNG" data-place-name="Location Name, City" title="📍 Location Name">Location Name</span>
...
3. Assign color indices for visual variety: data-color-index="0" through "9" (cycle 0,1,2...9,0,1... for each location)
4. For destinations, reference the origin using: data-transport-from="loc-1" (the ID of the starting location)
5. Specify transport mode: data-transport-profile="walking|driving|cycling|transit"
6. Provide APPROXIMATE coordinates (data-lat and data-lng) based on your knowledge - these help disambiguate locations
7. The data-place-name should include city/country context (e.g., "Eiffel Tower, Paris, France")
8. The system will fetch accurate coordinates from Google Places API using your approximate coords to disambiguate

Examples:
- First location: Start at <span class="geo-mark" data-geo-id="loc-1" data-color-index="0" data-lat="48.8566" data-lng="2.3522" data-place-name="Louvre Museum, Paris">Louvre Museum</span>.
- With transport: Walk to <span class="geo-mark" data-geo-id="loc-2" data-color-index="1" data-lat="48.8584" data-lng="2.2945" data-place-name="Eiffel Tower, Paris" data-transport-from="loc-1" data-transport-profile="walking">Eiffel Tower</span> (25 min walk).
- Next destination: Then take a taxi to <span class="geo-mark" data-geo-id="loc-3" data-color-index="2" data-lat="48.8606" data-lng="2.3376" data-place-name="Place de la Concorde, Paris" data-transport-from="loc-2" data-transport-profile="driving">Place de la Concorde</span>.
- In lists: <li><span class="geo-mark" data-geo-id="loc-4" data-color-index="3" data-lat="55.6414" data-lng="12.0803" data-place-name="Roskilde Station, Denmark">Roskilde Station</span>: Departure at 12:20</li>
